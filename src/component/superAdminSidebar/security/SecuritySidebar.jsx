      ...
      <div className="sidebar-content">
        ...
        <div className="sidebar-section">
          <ul className="nav nav-sidebar" data-nav-type="accordion">
            ...
            <li className="nav-item nav-item-submenu">
              <a href="#1" className="nav-link"><i className="icon-home4"></i> <span>Qabul</span></a>
              ...
              <ul className="nav nav-group-sub">
                ...
                <li className="nav-item">
                  <a href="#1" className="nav-link">Fuqarolar qabuli</a>
                </li>
              </ul>
            </li>
            <li className="nav-item nav-item-submenu">
              ...
              <ul className="nav nav-group-sub">
                <li className="nav-item">
                  <a href="index.html" className="nav-link">E'lon xabarnomasi</a>
                </li>
              </ul>
            </li>
          </ul>
