...
const ChiquvchiImzolanganContent = ({ currentUser, permission, ranks }) => {
                        ...
                        <td className="harakat">
                          <div>
                            ...
                            <div
                              ...
                              <Link
                                to={`/chiquvchi/ko'rish/imzolangan/${data?.id}`}
...
export default React.memo(ChiquvchiImzolanganContent);