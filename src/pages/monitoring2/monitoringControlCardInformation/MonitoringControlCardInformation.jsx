...
const MonitoringControlCardInformation = ({ currentUser }) => {
    ...
    return (
        <div className="content mb-5">
            <h3 style={{ margin: "10px 0 0 0", fontWeight: "bold", textTransform: "upperCase" }}>Nazorat Kartochkasi ma'lumot</h3>
...
export default React.memo(MonitoringControlCardInformation);