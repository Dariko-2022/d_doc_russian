...
import './fuqaroSavollariContent.css';
import MurojaatNavbar from '../../murojaatNavbar/MurojaatNavbar';

export default function FuqaroSavollariContent() {
                      ...
                      <tr key={index} className="text-center">
                        ...
                        <td>
                          <div className="icon d-flex justify-content-center align-items-center ">
                            {/* <i className="icon-pen btn btn-dark mr-1 d-flex align-items-center cursor-pointer" title="O'zgartirish" onClick={() => setUpdateModal({ open: true, obj: dat })} /> */}
                            {/* <i className="icon-trash btn btn-dark ml-1 d-flex align-items-center cursor-pointer" title="O'chirish" onClick={() => setDeleteModal({ delete: true, obj: dat })} /> */}
