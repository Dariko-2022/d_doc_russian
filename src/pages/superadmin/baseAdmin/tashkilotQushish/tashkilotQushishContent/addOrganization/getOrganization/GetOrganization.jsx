...
const GetOrganization = ({ setAlert, currentUser, sitrref, sitr2ref, orgNameref, shortDescref, addressref, fullNameref, phoneref, emailref, cityref, clearAllInputData, setIsChecked, isChecked }) => {
    ...
    <form>
      <div className="row">
        <div className="col-lg-1 d-flex align-items-center justify-content-center mb-3">
          <input type={'checkbox'} onChange={checkedHandler} style={{ transform: 'scale(1.4)' }} />
        </div>
...
export default React.memo(GetOrganization);