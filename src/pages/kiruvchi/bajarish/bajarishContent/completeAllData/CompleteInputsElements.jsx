...
const CompleteInputsElements = ({ setData, setSelected }) => {
  ...
  const SearchData = useCallback(async () => {
    ...
    try {
      ...
      setData(res.data);
      setSelected(0);
      extensiveSearchBackPageId({ selected: 0, pageName: "bajarishPageId" });
    } catch (error) {
...
export default React.memo(CompleteInputsElements);