...
const GenerallerInputsElements = ({ setData, setSelected }) => {
  ...
  const All = useCallback(async () => {
    try {
      ...
      setData(res.data);
      setSelected(0);
      extensiveSearchBackPageId({ selected: 0, pageName: "umumlashtiruvchiPageId" })
    } catch (error) {
...
export default React.memo(GenerallerInputsElements);