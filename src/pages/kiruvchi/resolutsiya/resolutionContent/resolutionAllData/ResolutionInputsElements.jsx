...
const ResolutionInputsElements = ({ setData, setSelected }) => {
  ...
  const All = useCallback(async () => {
    try {
      ...
      setBarchasi(!barchasi)
      setData(res.data);
      setSelected(0);
      extensiveSearchBackPageId({ selected: 0, pageName: "rezolutsiyaPageId" })
    } catch (error) {
...
export default React.memo(ResolutionInputsElements);