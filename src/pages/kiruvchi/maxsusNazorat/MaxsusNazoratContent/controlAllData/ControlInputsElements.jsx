...
const ControlInputsElements = ({ setData, dateFormatSet, setSelected }) => {
  ...
  const All = async () => {
    try {
      ...
      setData(res.data);
      setSelected(0);
      extensiveSearchBackPageId({ selected: 0, pageName: "nazoratdaPageId" })
    } catch (error) {
...
export default React.memo(ControlInputsElements);