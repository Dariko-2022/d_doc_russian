...
const TaskControlInputsElementsHome = ({ setTableData, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
...
export default React.memo(TaskControlInputsElementsHome);