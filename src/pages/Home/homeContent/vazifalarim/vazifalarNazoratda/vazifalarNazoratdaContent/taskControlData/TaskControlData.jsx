...
const TaskControlData = ({ tableData, setTableData, currentUser, permission, dateFormatSet, korresref, shortDescref, regNumref }) => {
  ...
  const handlePageClick = async (e) => {
    ...
    try {
      const res = await axiosInstance.post(`mainPage/inControl/${JSON.parse(localStorage.getItem('ids'))}`, {
            ...
            <tr key={index}
              ...
              <td className="harakat mobile-table-none">
                <div className="icon d-flex justify-content-center align-items-center ">
                  <Link to={permission ? `/bosh_sahifa_ko'rish/${tableItem?.id}/vazifalarim` : `/kiruvchi_bajarish_ijro/${tableItem?.id}/nazorat`}
...
export default React.memo(TaskControlData);