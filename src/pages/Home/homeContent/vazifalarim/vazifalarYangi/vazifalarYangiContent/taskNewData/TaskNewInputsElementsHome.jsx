...
const TaskNewInputsElementsHome = ({ setTableData, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
    ...
    <table className={'table-sm-full'}>
      <thead>
        <tr className={'direction-mobile'}>
          ...
          <th style={{ width: '350px' }}>
            <div
              className="form-group form-group-feedback form-group-feedback-left inp inp-sm-none hmmm ">
              <div
...
export default React.memo(TaskNewInputsElementsHome);