...
const TaskNewData = ({ tableData, setTableData, permission, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
        ...
        <tbody>
          {tableData?.content?.map((tableItem, index) => (
            ...
            >
              ...
              <td className="text-color xujjat Fayl mobile-table-none">
              ...
              <td className="text-center korres">{tableItem.correspondentName}</td>
              <td className="text-center qisqacha mobile-table-none">{tableItem.shortDescription}</td>
              ...
              <td className="harakat mobile-table-none">
                <div className="icon d-flex justify-content-center align-items-center ">
                  <Link to={permission ? `/bosh_sahifa_ko'rish/${tableItem?.id}/vazifalarim` : tableItem?.tabName === "SUPER_VISOR" ? `/kiruvchi_bajarish_ijro/${tableItem?.id}/nazorat` : tableItem?.tabName === "GENERALLER" ? `/kiruvchi_bajarish_ijro/${tableItem?.id}/umumlashtiruvchi` : tableItem?.tabName === "FOR_DOING" ? `/kiruvchi_bajarish_ijro/${tableItem?.id}/bajarish` : `/kiruvchi_bajarish_ijro/${tableItem?.id}/malumot`}
...
export default React.memo(TaskNewData);