...
const TaskProgresData = ({ tableData, setTableData, dateFormatSet, currentUser, permission, korresref, shortDescref, regNumref }) => {
...
export default React.memo(TaskProgresData);