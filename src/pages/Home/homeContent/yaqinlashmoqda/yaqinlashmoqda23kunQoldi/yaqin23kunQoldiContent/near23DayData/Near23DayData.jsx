...
const Near23DayData = ({ data, setData, permission, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
  ...
  const handlePageClick = async (e) => {
    ...
    try {
      const res = await axiosInstance.post(`mainPage/remainTwoThreeDay/${JSON.parse(localStorage.getItem('ids'))}`, {
...
export default React.memo(Near23DayData);