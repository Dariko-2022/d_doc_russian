...
const Near23DayInputsElementsHome = ({ setData, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
...
export default React.memo(Near23DayInputsElementsHome);