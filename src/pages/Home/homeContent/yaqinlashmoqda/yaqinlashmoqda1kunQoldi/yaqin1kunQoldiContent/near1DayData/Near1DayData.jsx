...
const Near1DayData = ({ tableData, setTableData, permission, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
  ...
  const handlePageClick = async (e) => {
    ...
    try {
      const res = await axiosInstance.post(`mainPage/remainOneDay/${JSON.parse(localStorage.getItem('ids'))}`, {
...
export default React.memo(Near1DayData);