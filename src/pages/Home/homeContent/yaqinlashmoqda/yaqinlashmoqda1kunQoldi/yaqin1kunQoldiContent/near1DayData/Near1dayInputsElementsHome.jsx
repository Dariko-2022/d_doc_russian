...
const Near1dayInputsElementsHome = ({ setTableData, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
...
export default React.memo(Near1dayInputsElementsHome);