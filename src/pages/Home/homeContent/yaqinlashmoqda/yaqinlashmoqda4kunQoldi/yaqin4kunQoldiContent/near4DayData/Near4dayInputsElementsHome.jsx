...
const Near4dayInputsElementsHome = ({ setData, dateFormatSet, currentUser, korresref, shortDescref, regNumref }) => {
...
export default React.memo(Near4dayInputsElementsHome);