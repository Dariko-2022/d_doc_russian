...
const NewDataInputsElementsHome = ({ setData, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
  ...
  const SearchData = async () => {
    ...
    try {
      const res = await axiosInstance.post(`mainPage/allNear/` + JSON.parse(localStorage.getItem('ids')), {
...
export default React.memo(NewDataInputsElementsHome);