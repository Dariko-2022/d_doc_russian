...
const DoneInputsElementsHome = ({ setData, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
  ...
  const SearchData = async () => {
    ...
    try {
      const res = await axiosInstance.post(`mainPage/allDone/` + JSON.parse(localStorage.getItem('ids')), {
              ...
              <div className="inputBox d-flex align-items-center justify-content-end input-border" style={{ height: "44px" }}>
                ...
                <div className='changeBox ' style={{ width: '200px' }}>
                  <DatePicker
                    ...
                    isClearable
                    name="startDate1" // vazifasi date ni ustiga bosganda chiqadigan padskazkani ko'rsatmaslik uchun
                    showYearDropdown
...
export default React.memo(DoneInputsElementsHome);