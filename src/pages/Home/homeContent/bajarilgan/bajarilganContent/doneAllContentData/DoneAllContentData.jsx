...
const DoneAllContentData = ({ data, dateFormatSet, currentUser, setData, permission, korresref, shortDescref, regNumref }) => {
...
export default React.memo(DoneAllContentData);