...
const DoneDelayAllContent = ({ data, setData, currentUser, dateFormatSet, permission, korresref, shortDescref, regNumref }) => {
...
export default React.memo(DoneDelayAllContent);