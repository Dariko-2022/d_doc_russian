...
const DoneDelayInputsElementsHome = ({ dateFormatSet, currentUser, setData, korresref, shortDescref, regNumref }) => {
  ...
  const SearchData = async () => {
    ...
    try {
      const res = await axiosInstance.post(`mainPage/defferedDone/` + JSON.parse(localStorage.getItem('ids')), {
...
export default React.memo(DoneDelayInputsElementsHome);