...
const NotDoneDataInputsElementsHome = ({ setData, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
...
export default React.memo(NotDoneDataInputsElementsHome);