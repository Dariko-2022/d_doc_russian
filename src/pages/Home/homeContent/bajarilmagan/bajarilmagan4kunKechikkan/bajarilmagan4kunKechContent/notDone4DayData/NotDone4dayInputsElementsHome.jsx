...
const NotDone4dayInputsElementsHome = ({ setData, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
  ...
  const SearchData = async () => {
    ...
    try {
      const res = await axiosInstance.post(`mainPage/lateMoreThanFourDay/` + JSON.parse(localStorage.getItem('ids')), {
...
export default React.memo(NotDone4dayInputsElementsHome);