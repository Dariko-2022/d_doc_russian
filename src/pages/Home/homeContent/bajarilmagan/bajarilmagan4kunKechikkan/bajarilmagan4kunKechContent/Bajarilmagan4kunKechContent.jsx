...
import NotDone4DayData from "./notDone4DayData/NotDone4DayData";
import NotDone4dayInputsElementsHome from "./notDone4DayData/NotDone4dayInputsElementsHome";

const Bajarilmagan4kunKechContent = ({ permission, currentUser }) => {
  ...
  useEffect(() => {
    let isMounted = true;
    const getData = async () => {
      const res = await axiosInstance.post(`mainPage/lateMoreThanFourDay/${localStorage.getItem('ids')}`, {
        correspondentName: "",
        shortDescription: "",
        out_number: "",
        out_date: '',
...
export default React.memo(Bajarilmagan4kunKechContent);