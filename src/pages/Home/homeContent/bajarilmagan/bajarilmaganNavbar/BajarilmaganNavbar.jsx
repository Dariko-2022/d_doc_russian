    ...
    <>
      ...
      <li className="nav-item">
        <NavLink to="/bajarilmagan_1kun-kechikkan" className="nav-link" activeClassName='NavLinkLi'>
          <i className="icon-newspaper mr-1 sx-none" /> 1 kun kechikkan
        </NavLink>
      ...
      <li className="nav-item">
        <NavLink to="/bajarilmagan_2-3kun-kechikkan" className="nav-link" activeClassName='NavLinkLi'>
          <i className="icon-user-plus mr-1 sx-none" /> 2-3 kun kechikkan
        </NavLink>
      ...
      <li className="nav-item">
        <NavLink to="/bajarilmagan_4~kun-kechikkan" className="nav-link" activeClassName='NavLinkLi'>
          <i className="icon-pen mr-1 sx-none" /> 4 (~) kun kechikkan
        </NavLink>
        {data.lateMoreThanFourDayTask !== 0 && data.lateMoreThanFourDayTask !== null && data.lateMoreThanFourDayTask !== undefined && (
