...
import NotDone1DayData from "./notDone1DayData/NotDone1DayData";
import NotDone1dayInputsElementsHome from "./notDone1DayData/NotDone1dayInputsElementsHome";

const Bajarilmagan1kunKechContent = ({ permission, currentUser }) => {
...
export default React.memo(Bajarilmagan1kunKechContent);