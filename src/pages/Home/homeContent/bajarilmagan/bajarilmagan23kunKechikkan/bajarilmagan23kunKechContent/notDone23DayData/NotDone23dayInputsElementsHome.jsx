...
const NotDone23dayInputsElementsHome = ({ setData, currentUser, dateFormatSet, korresref, shortDescref, regNumref }) => {
  ...
  const SearchData = async () => {
    ...
    try {
      const res = await axiosInstance.post(`mainPage/lateTwoThreeDay/` + JSON.parse(localStorage.getItem('ids')), {
...
export default React.memo(NotDone23dayInputsElementsHome);